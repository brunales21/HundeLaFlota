public class FabricaDeBarcos {
    ...
    public Barco[] getNewBarcos() {
        ...
        Barco z = new Barco(new SuperString("O ", Color.WHITE), new ParteDeBarco[]{new ParteDeBarco(new SuperString("  ", Color.WHITE, Color.WHITE_BACKGROUND), 0, 0), new ParteDeBarco(new SuperString("  ", Color.WHITE, Color.WHITE_BACKGROUND), 0, 1), new ParteDeBarco(new SuperString("  ", Color.WHITE, Color.WHITE_BACKGROUND), 1, 1), new ParteDeBarco(new SuperString("  ", Color.WHITE, Color.WHITE_BACKGROUND), 1, 2)});
